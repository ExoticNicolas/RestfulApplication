...
public class BookController {
	...
	@GetMapping(value = "/findBookByAuthor/{author}",produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML})
	@Operation(summary = "Finds All Books", description = "Finds All Books",
	tags = {"Books"},
	responses = {
			@ApiResponse(description = "Success", responseCode = "200",
	...
	public ResponseEntity<PagedModel<EntityModel<BookVO>>> findBookByAuthor(
		...
		return ResponseEntity.ok().body(bookService.findBookByAuthor(author,pageable));
	}
