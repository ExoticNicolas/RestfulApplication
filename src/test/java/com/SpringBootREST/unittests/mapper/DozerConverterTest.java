...
public class DozerConverterTest {
    ...
    public void parseEntityToVOTest() {
        ...
        assertEquals("Adress Test0", output.getAdress());
    ...
    public void parseEntityListToVOListTest() {
        ...
        assertEquals("Adress Test0", outputZero.getAdress());
        ...
        assertEquals("Adress Test7", outputSeven.getAdress());
        ...
        assertEquals("Adress Test12", outputTwelve.getAdress());
